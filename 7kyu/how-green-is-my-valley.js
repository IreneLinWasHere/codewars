...
let arr = [67, 93, 100, -16, 65, 97, 92] // answer: [100, 93, 67, *-16*, 65, 92, 97]

function makeValley(arr) {
    let sorted = arr.sort((a, b) => b - a)
    let left = sorted.filter((e, i) => i % 2 === 0)
    let right = sorted.filter((e, i) => i % 2 === 1).reverse()

    return left.concat(right)
}

console.log(makeValley(arr))